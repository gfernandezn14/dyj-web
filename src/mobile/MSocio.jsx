  ...
  return (
    <>
      ...
      <section className="m-sec">
        ...
        <h2 className="m-title">Lo que recibes<br /><span style={{ color: 'var(--dyj-red-text)' }}>por ser parte</span></h2>
        <ul style={{ listStyle: 'none', padding: 0, margin: '28px 0 0', display: 'flex', flexDirection: 'column', gap: 0 }}>
          {BENEFICIOS.map((b, i) => (
            <li key={i} style={{ display: 'grid', gridTemplateColumns: 'auto 1fr', gap: 14, alignItems: 'baseline', padding: '16px 0', borderBottom: '1px solid rgba(0,0,0,0.1)', borderTop: i === 0 ? '1px solid rgba(0,0,0,0.1)' : 'none' }}>
              <span style={{ fontFamily: 'var(--font-mono)', color: 'var(--dyj-red-text)', fontSize: 12, letterSpacing: '0.18em' }}>
          ...
          {APORTES.map((a) => {
            ...
            return (
              <div key={a.tier} style={{
                ...
                <div style={{ fontFamily: 'var(--font-mono)', fontSize: 10, letterSpacing: '0.22em', textTransform: 'uppercase', color: esHonor ? 'var(--dyj-gold)' : 'var(--dyj-red-text)' }}>
                  Socio {a.tier}
                </div>
      ...
      <section className="m-sec">
        ...
        {sent ? (
          <div style={{ border: '2px solid var(--dyj-ink)', padding: 32, marginTop: 24, textAlign: 'center' }}>
            <div className="m-title" style={{ color: 'var(--dyj-red-text)', fontSize: 48, marginBottom: 10 }}>¡Bienvenido!</div>
