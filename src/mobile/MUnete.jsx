...
export default function MUnete() {
  ...
  return (
    <>
      <MPageHeader
        kicker="05 · Únete"
        title={<>Queremos verte<br /><span style={{ color: 'var(--dyj-red-text)' }}>en la cancha</span></>}
      ...
      <section className="m-sec m-sec--bone">
        {sent ? (
          <div style={{ border: '2px solid var(--dyj-ink)', padding: 32, textAlign: 'center' }}>
            <div className="m-title" style={{ color: 'var(--dyj-red-text)', fontSize: 48, marginBottom: 10 }}>¡Listo!</div>
